...
def test_build_and_validate_spine():
    g = build_claim_graph(401, spine=_spine_401(), signals=_signals_ready_for_subro())
...
def test_route_litigation():
    ...
    g = build_claim_graph(402, spine=spine, signals={})
    decision = route_claim(g, 402)
...
def test_route_closed_terminal():
    ...
    spine["subrogation_indicator"] = False
    g = build_claim_graph(403, spine=spine, signals={})
    decision = route_claim(g, 403)
